        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-center border-r w-[120px]">Sort Order</TableHead>
                ...
                <TableRow key={category.id} className="hover:bg-muted/50 transition-colors">
                  ...
                  <TableCell className="border-r">
                    <Input
                      ...
                      onChange={(e) =>
                        handleFieldChange(category.id, "description", e.target.value)
                      }
                  ...
                  <TableCell className="border-r">
                    <Select
                      value={category.type}
                      onValueChange={(value) => handleFieldChange(category.id, "type", value)}
                    >
