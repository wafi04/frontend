...
import { Loader2, Save, Upload, Globe, Building2, Share2, MessageCircle, Settings } from "lucide-react";
...
const webSettingsSchema = z.object({
  ...
  url_saluran_whatsapp: z.string().url("Invalid URL").optional().or(z.literal("")),
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Basic information about your website including name, description, and SEO settings.
            </CardDescription>
          </CardHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Your website's catchy tagline" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="123 Business Street, City, State, ZIP" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="https://whatsapp.com/channel/..." {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    This message will be pre-filled when users click WhatsApp links
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Additional footer information..." {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
